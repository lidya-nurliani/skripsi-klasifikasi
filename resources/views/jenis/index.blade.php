                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h4 class="mt-1 mb-1 font-18 ellipsis">Data Jenis Kendaraan</h4>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="text-right">
                                            <a href="{{ route('jenis.create') }}"> <button type="button" class="btn btn-success waves-effect waves-light btn-md"><i class="fe-plus-square"></i>Tambah Data</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table id="datatable" class="table table-bordered  dt-responsive nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="{{ route('jenis.edit', $item->id) }}"><i class="fas fa-edit"></i></a>
                                        |
